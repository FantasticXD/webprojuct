    ...
    <script type="text/javascript">
        $(function () {
            $("#searchPageButton").click(function () {
                ...
                location.href = "${pageScope.basePath}client/bookServlet?action=page&pageNum=" + pageNum;
            ...
            $("button.addToCart").click(function () {
                ...
                if (${empty sessionScope.user.username}) {
                    ...
                    $.getJSON("${basePath}cartServlet" ,"action=addItem&bookId="+ bookId,function (data) {
...
<div id="header">
    ...
    <div>
        ...
        <c:if test="${not empty sessionScope.user.username}">
            <%--            <span style="height: 40px;font-size: 20px;color: red">${sessionScope.user.username}</span>--%>
            <a href="#" style="font-size: 20px;color: red">${sessionScope.user.username}</a>
